...
public class ModMenuTypes {
    ...
    public static final ExtendedScreenHandlerType<SimpleStorageBoxMenu> SIMPLE_STORAGE_BOX_MENU = new ExtendedScreenHandlerType<>(SimpleStorageBoxMenu::new);
    ...
    public static void register() {
        ...
        Registry.register(BuiltInRegistries.MENU, new ResourceLocation(FXNTStorage.MOD_ID, "simple_storage_box_menu"), SIMPLE_STORAGE_BOX_MENU);
